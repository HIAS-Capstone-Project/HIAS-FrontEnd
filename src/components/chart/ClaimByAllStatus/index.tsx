...
import { claimByStatusChart } from 'services/dashboard.service';
...
const ClaimByAllStatus = ({ role }: LocationChartIF) => {
...
export default ClaimByAllStatus;
